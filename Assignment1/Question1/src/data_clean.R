data=read.csv("C:/Users/ADMIN/OneDrive/Documents/Github/Assignment/Question1/data_raw/data_raw_file.csv")
...
write.csv(data,"C:/Users/ADMIN/OneDrive/Documents/Github/Assignment/Question1/data_clean/clean_data.csv")
